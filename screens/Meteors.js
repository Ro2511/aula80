...
import {Text, View, Alert, StyleSheet, SafeAreaView, Platform, StatusBar, FlatList, Image, ImageBackground, Dimensions} from "react-native";
...
export default class MeteorsScreen extends Component{
    ...
    getMeteors =() => {
        axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=mKfnXf4qS8PAwC3ajeJKxIubXopgrN4Ah6D75kQb")
        .then(response => {
    ...
    //função que irá mostrar os meteoros de acordo com o perigo
    renderItem = ({ item }) => {
        let meteor = item
    ...
    render() {
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            //funcão que organiza os meteoros em ordem de perigo
            meteors.sort(function(a,b){
                return b.threatScore -a.threat_score
            })
            meteors = meteors.slice(0,5);//seleciona os 5 mais ameaçadores
